             ...
             <h2 className="text-sm font-bold text-app-text mb-4 flex items-center gap-2">
              ...
              <div className="bg-white rounded-[2rem] p-5 shadow-sm border border-app-card/30">
                  <div className="flex gap-4">
                     ...
                     <div>
                        <h3 className="text-sm font-bold text-app-text">{bookingItem.product.name}</h3>
                        {bookingItem.packageOption ? (
                           <div className="flex gap-2 mt-1">
                              <span className="text-[10px] bg-app-gold/10 text-app-gold px-2 py-0.5 rounded-md font-bold">
                        ...
                        <p className="text-sm font-bold text-app-gold mt-1.5">{totalAmountNum.toFixed(3)} د.ك</p>
                     </div>
                  </div>
              </div>
        </section>
      ...
      <div className="fixed bottom-[74px] left-0 right-0 p-6 bg-white border-t border-app-card/30 z-40 max-w-[430px] mx-auto shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center justify-between bg-app-gold/10 p-3 rounded-xl">
            <span className="text-sm font-bold text-app-gold">المبلغ المطلوب الآن:</span>
        ...
        <button 
          ...
          className="w-full bg-app-gold text-white font-bold py-4 rounded-2xl shadow-lg shadow-app-gold/30 active:scale-95 transition-transform flex items-center justify-center gap-2 disabled:opacity-50 disabled:bg-gray-300 disabled:shadow-none"
        >
          {isProcessing ? (
      ...
      <div className="bg-app-bg px-6 py-3 rounded-2xl mb-10 border border-app-card/30">
        <div className="flex items-center justify-between gap-8 mb-2">
            <div className="text-center">
                 <span className="text-app-textSec text-[10px] font-bold block">رقم الحجز</span>
                 <span className="text-app-text font-bold text-sm">#{lastOrderId}</span>
            </div>
            <div className="text-center">
                 <span className="text-app-textSec text-[10px] font-bold block">المدفوع</span>
                 <span className="text-app-gold font-bold text-sm">{lastPaidAmount} د.ك</span>
            </div>
        </div>
      </div>
