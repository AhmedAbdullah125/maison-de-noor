      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 pb-28 pt-24">
        {isGuest ? (
           <div className="h-full flex flex-col items-center justify-center text-center opacity-60 pb-10">
              ...
              <h2 className="text-lg font-bold text-app-text mb-2">سجلي دخولك لرؤية التنبيهات</h2>
             ...
             {notifications.map((n) => (
                ...
                >
                   <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-1 text-[10px] text-app-textSec font-bold" dir="ltr">
                         <Clock size={10} />
                         <span>{new Date(n.createdAt).toLocaleDateString('ar-EG')}</span>
                      </div>
                   </div>
                   <p className="text-sm font-bold text-app-text leading-relaxed mb-4">{n.messageText}</p>
                   ...
                   <div className="flex items-center justify-between mt-auto pt-3 border-t border-app-bg">
                      {n.linkUrl ? (
                         <a 
                           ...
                           target="_blank" 
                           rel="noreferrer" 
                           className="flex items-center gap-1 text-[10px] font-black text-app-gold underline decoration-dotted"
