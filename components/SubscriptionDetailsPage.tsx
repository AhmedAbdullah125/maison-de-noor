    ...
    <div className="flex flex-col h-full bg-app-bg relative font-alexandria overflow-hidden min-h-screen animate-fadeIn">
      ...
      {isNewPurchase && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 w-[90%] max-w-[380px] bg-green-500 text-white py-3 px-4 rounded-2xl shadow-xl flex items-center gap-3 z-[60] animate-slideUp">
          ...
          <span className="font-bold text-sm">تم شراء الباقة بنجاح</span>
        </div>
      )}
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-28 px-6 pt-24 space-y-6">
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-app-card/30">
          <div className="flex justify-between items-start mb-4">
             ...
             <span className={`text-[10px] font-bold px-2.5 py-1 rounded-lg border ${getStatusStyle(subscription.status)}`}>
          ...
          <div className="bg-app-bg/50 rounded-2xl p-4">
            <div className="flex justify-between items-end mb-2">
                <span className="text-xs font-bold text-app-textSec">الجلسات المتبقية</span>
                <span className="text-sm font-bold text-app-gold">{remaining} من {subscription.sessionsTotal}</span>
            </div>
        ...
        {isExpired && (
           <div className="bg-red-50 border border-red-100 rounded-2xl p-4 flex items-center gap-3 text-red-600">
              <AlertCircle size={20} />
              <span className="font-bold text-sm">هذا الاشتراك منتهي</span>
           </div>
        )}
        ...
        {!isExpired && (
          <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-app-card/30">
             <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-base font-bold text-app-text">الجلسة القادمة</h3>
             </div>
             ...
             {subscription.nextSession ? (
                <>
                   <div className="bg-app-gold/5 border border-app-gold/20 rounded-2xl p-4 mb-4 flex justify-between items-center">
                      <div className="flex flex-col">
                         <span className="text-sm font-bold text-app-text" dir="ltr">{subscription.nextSession.date}</span>
                   ...
                   <button 
                     ...
                     className="w-full bg-white border border-app-gold text-app-gold font-bold py-3.5 rounded-xl shadow-sm active:bg-app-bg transition-colors flex items-center justify-center gap-2"
                   >
                ...
                <>
                   <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 mb-4 text-center">
                      <span className="text-sm font-bold text-app-textSec">غير محدد</span>
                   </div>
                   <button 
                     onClick={handleBookNext}
                     className="w-full bg-app-gold text-white font-bold py-3.5 rounded-xl shadow-lg shadow-app-gold/20 active:scale-[0.98] transition-transform flex items-center justify-center gap-2"
                   >
                      <CalendarDays size={18} />
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-app-card/30">
           <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-bold text-app-text">ماذا يتضمن الاشتراك؟</h3>
           </div>
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-app-card/30">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-bold text-app-text">الشروط</h3>
           </div>
           <ul className="list-disc list-outside pr-4 text-xs text-app-textSec space-y-2 mb-3 leading-relaxed">
            ...
            <button 
                ...
                className="text-xs font-bold text-app-gold underline"
            >
                عرض جميع الشروط
            </button>
        </div>
        ...
        {/* 7) Sessions History */}
        <div className="pb-8">
           <h3 className="text-base font-bold text-app-text mb-4 px-2">سجل الجلسات</h3>
                 ...
                 {mockHistory.map((item, idx) => (
                    <div key={idx} className="bg-white rounded-2xl p-4 shadow-sm border border-app-card/30 flex justify-between items-center">
                       <div className="flex items-center gap-3">
                          ...
                          <div>
                             <span className="block text-xs font-bold text-app-text">جلسة {subscription.sessionsUsed - idx}</span>
      ...
      {showTerms && (
          <div className="absolute inset-0 z-[60] bg-black/50 backdrop-blur-sm flex items-end animate-fadeIn">
              ...
              >
                  ...
                  <h2 className="text-xl font-bold text-app-text mb-6">الشروط والأحكام</h2>
