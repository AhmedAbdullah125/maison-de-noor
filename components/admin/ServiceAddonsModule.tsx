    ...
    <div className="space-y-8 animate-fadeIn">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">{t.serviceAddons}</h2>
          ...
          {addons.map((addon) => (
            ...
            >
              ...
              <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                ...
                <button
                  onClick={() => handleOpenModal(addon)}
                  className="text-xs font-semibold text-[#483383] hover:underline flex items-center gap-1"
                >
          ...
          <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden animate-scaleIn">
            ...
            <div className="px-10 py-8 flex gap-4 bg-gray-50/30">
              <button
                ...
                className="flex-1 py-4 font-semibold text-gray-700 bg-white border border-gray-200 rounded-2xl hover:bg-gray-50 active:scale-95 transition-all"
              ...
              <button
                ...
                disabled={deletingId === addonToDelete.id}
                className="flex-1 py-4 font-semibold text-white bg-red-500 rounded-2xl shadow-lg hover:bg-red-600 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-60"
              >
