...
export const translations = {
  en: {
    ...
    position: 'Position',
    saving: 'Saving...',
    currentImageHint: 'Current image (optional to change)',
    imageConvertedHint: 'Image converted to URL',
    ...
    pointsSettings: 'Points & Loyalty',
    pointsSettingsHint: 'Configure how customers earn and convert loyalty points',
    pointsSettingsDescription: 'Points are earned per unit spent on a paid order, then instantly converted to wallet credit using the conversion rate below. Changes apply immediately to new orders only.',
    earnRate: 'Earn Rate',
    earnRateHint: 'Points earned per 1 unit of an order\'s final price',
    conversionRate: 'Conversion Rate',
    conversionRateHint: 'Points required to equal 1 unit of wallet credit',
    ...
    paymentInfo: 'Payment & Pricing',
    basePrice: 'Base Price',
    optionsPrice: 'Options Price',
    totalPrice: 'Total Price',
    discount: 'Discount',
    walletUsed: 'Wallet Used',
    sessionsInfo: 'Sessions Details',
    ...
    bookingLimitPerTime: 'Limit / Time Slot',
    dailyAppointments: 'Daily Capacity',
  ...
  ar: {
    ...
    position: 'الترتيب',
    saving: 'جاري الحفظ...',
    currentImageHint: 'الصورة الحالية (اختياري تغييرها)',
    imageConvertedHint: 'تم تحويل الصورة إلى رابط نصّي',
    ...
    pointsSettings: 'النقاط والولاء',
    pointsSettingsHint: 'إعداد كيفية اكتساب العملاء للنقاط وتحويلها',
    pointsSettingsDescription: 'تُكتسب النقاط لكل وحدة يتم إنفاقها في طلب مدفوع، ثم تُحوَّل فوراً إلى رصيد في المحفظة باستخدام معدل التحويل أدناه. التغييرات تُطبَّق فوراً على الطلبات الجديدة فقط.',
    earnRate: 'معدل الاكتساب',
    earnRateHint: 'عدد النقاط المكتسبة لكل وحدة من السعر النهائي للطلب',
    conversionRate: 'معدل التحويل',
    conversionRateHint: 'عدد النقاط المطلوبة لتعادل وحدة واحدة من رصيد المحفظة',
    ...
    noCustomerData: 'لا تتوفر بيانات العميلة',
    language: 'اللغة',
    verified: 'موثق',
    memberSince: 'عضو منذ',
    paymentInfo: 'الدفع والتسعير',
    basePrice: 'السعر الأساسي',
    optionsPrice: 'سعر الخيارات',
    totalPrice: 'الإجمالي',
    discount: 'الخصم',
    walletUsed: 'المحفظة مستخدمة',
    sessionsInfo: 'تفاصيل الجلسات',
    totalSessions: 'إجمالي الجلسات',
    validity: 'فترة الصلاحية',
    validFromDate: 'صالح من',
    ...
    bookingLimitPerTime: 'الحد / الوقت',
    dailyAppointments: 'الطاقة اليومية',
    optionsCount: 'عدد الخيارات',
    availablePlans: 'الباقات المتاحة',
    pricePerSession: 'لكل جلسة',
    selected: 'محدد',
